...
let containerscrollcontainerscroll=document.querySelector(".image-list5");
let Btnbackbtnback=document.getElementById("backBtn5");
let Btnnextbtnnext=document.getElementById("nextBtn5");

    containerscrollcontainerscroll.addEventListener("wheel",(evt) =>{
    evt.preventDefault();
    containerscrollcontainerscroll.scrollLeft+=evt.deltaY;
    containerscrollcontainerscroll.style.scrollBehavior="auto";
});

Btnnextbtnnext.addEventListener("click",() =>{
    containerscrollcontainerscroll.style.scrollBehavior="smooth";
    containerscrollcontainerscroll.scrollLeft+=900;
});

Btnbackbtnback.addEventListener("click",() =>{
    containerscrollcontainerscroll.style.scrollBehavior="smooth";
    containerscrollcontainerscroll.scrollLeft+=-900;
});